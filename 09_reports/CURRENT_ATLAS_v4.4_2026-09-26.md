...
Current research release: **v4.4 · 2026-09-26**

- HTML: `09_reports/SIMS_FULL_COMPETITOR_INTELLIGENCE_ATLAS_v4.4_2026-09-26.html`
- Release notes: `09_reports/SIMS_FULL_COMPETITOR_INTELLIGENCE_ATLAS_v4.4_RELEASE_NOTES_2026-09-26.md`
- Big Farm current US store/monetization: `06_ua_liveops/BIG_FARM_HOMESTEAD_US_CURRENT_STORE_MONETIZATION_v0.1_2026-09-26.csv`
...
Scope remains **US-first / Global-secondary**. Big Farm current US store evidence is separated from Global Android, Unity technical evidence and Stillfront franchise/company reporting. Trend/Cause is E1 only and uses same-scope collection data without relabeling it US.
